...
const IrregularStudent = () => {
  ...
  // Filter only irregular students
  const irregularStudents = allStudents.filter(student => student.status === 'Irregular');
  ...
  return (
    <main>
      ...
      <ul className="flex gap-1 text-sm">
        ...
        <li><a href="#" className="text-gray-700 font-semibold">Irregular Students</a></li>
      </ul>

      <h3 className="text-2xl font-semibold pt-6 pb-6">Irregular Students Data Summary</h3>
      ...
      <div className="bg-white rounded-lg p-6">
        <table className="min-w-full table-auto border-collapse">
          ...
          <tbody className="text-sm">
            {/* Render only irregular students */}
            {irregularStudents.length > 0 ? (
              ...
              <tr>
                <td colSpan="10" className="px-4 py-2 text-center">No Irregular Students Found</td>
              </tr>
            )}
          </tbody>
        </table>
...
export default IrregularStudent;
