    ...
    <section className="home" id="home">
      ...
      <section className="overlay-section relative py-16 bg-gray-100">
        <div className="absolute inset-0 flex justify-center items-center z-10 mt-[-80px]">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 px-6 sm:px-20">
            <div
            ...
            >
              ...
              <p className="text-center text-white">New students including the transferees, currently grade 12 student, new graduates from Senior High School and other students
                who are about to enroll can click "Apply Now" to register and proceed to the admission portal.</p>
            </div>
            <div
              className="p-8 rounded-lg shadow-xl transform hover:scale-105 transition-transform duration-300"
              style={{ backgroundColor: '#208245' }}
            >
              ...
              <p className="text-center text-white">Students with existing records can click "Login" 
                to access the student portal. The "Login" button will also allow staff and administrators 
                to access the system in order to provide updates to the students.</p>
            </div>
          </div>
        </div>
      </section>
