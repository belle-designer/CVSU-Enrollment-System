    ...
    <section className="about" id="about">
      <header className="section-header">
        ...
        <p>Cavite State University - Bacoor Campus was created on September 28, 2007, through Board Resolution No. 62, series of 2007.  
			It is one of the campuses of Cavite State University (CVSU), an 
			institution of learning that started out in 1906 as the 
			Indang Intermediate School.</p>
      </header>
      ...
      <div className="about-contents">
        <div className="service-box">
          <div className="service-desc">
            <h2>Mandate</h2>
            <p>Section 2 of Republic Act No. 8468 “An Act Converting the 
					Don Severino Agricultural College in the Municipality of Indang, 
					...
					education and other related fields, undertake research and extension services, 
					and provide progressive leadership in these areas.”</p>
          </div>
        </div>
        ...
        <div className="service-box">
          <div className="service-desc">
            <h2>Mission</h2>
            <p>Cavite State University shall provide excellent, equitable and relevant 
        ...
        <div className="service-box">
          <div className="service-desc">
            <h2>Vision</h2>
            <p>The premier university in historic Cavite globally recognized for 
					excellence in character development, academics, research, 
					innovation and sustainable community engagement.</p>
          </div>
        </div>
      </div>
    </section>
