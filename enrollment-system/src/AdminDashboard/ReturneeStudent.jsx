...
const ReturneeStudent = () => {
  ...
  // Filter only returnee students
  const returneeStudents = allStudents.filter(student => student.status === 'Returnee');
  ...
  return (
    <main>
      ...
      <ul className="flex gap-1 text-sm">
        ...
        <li><a href="#" className="text-gray-700 font-semibold">Returnee Students</a></li>
      </ul>

      <h3 className="text-2xl font-semibold pt-6 pb-6">Returnee Students Data Summary</h3>
      ...
      <div className="bg-white rounded-lg p-6">
        <table className="min-w-full table-auto border-collapse">
          ...
          <tbody className="text-sm">
            {/* Render only returnee students */}
            {returneeStudents.length > 0 ? (
              returneeStudents.map(student => (
              ...
              <tr>
                <td colSpan="10" className="px-4 py-2 text-center">No Returnee Students Found</td>
              </tr>
            )}
          </tbody>
        </table>
...
export default ReturneeStudent;
