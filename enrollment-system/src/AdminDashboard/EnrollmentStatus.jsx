...
const EnrollmentStatus = () => {
  ...
  const allStudents = [
    { id: 1, studentNo: '202211839', firstName: 'Mary Ann', middleName: 'Torres', lastName: 'Motol', suffix: 'NA', dob: '02/05/2001', program: 'BSCS', payStat: 'Paid', enrollStat: 'Enrolled' },
    { id: 2, studentNo: '202211840', firstName: 'John', middleName: 'William', lastName: 'Doe', suffix: 'Jr', dob: '10/02/2000', program: 'BSIT', payStat: 'Pending', enrollStat: 'Pending' },
    { id: 3, studentNo: '202211841', firstName: 'Jane', middleName: 'Marie', lastName: 'Smith', suffix: 'Sr', dob: '06/15/1999', program: 'BSIT', payStat: 'Pending', enrollStat: 'Pending' },
    { id: 4, studentNo: '202211842', firstName: 'Alice', middleName: 'Grace', lastName: 'Wang', suffix: 'NA', dob: '03/25/2002', program: 'BSCS', payStat: 'Paid', enrollStat: 'Pending' },
    // Add more students...
  ];
  ...
  const filterStudents = () => {
    const filtered = allStudents.filter((student) => {
      return (
        ...
        (status === 'all' || student.enrollStat.toLowerCase() === status.toLowerCase())
      );
    });
  ...
  return (
    <main>
      ...
      <h1 className="text-3xl font-semibold mb-2">Enrollment Status</h1>
      <ul className="flex gap-1 text-sm mb-5">
        ...
        <li className="text-gray-400">/</li>
        <li><a href="#" className="text-gray-700 font-semibold">Enrollment Status</a></li>
      </ul>
            ...
            <tbody className="text-sm">
              ...
              {currentRows.map((student) => (
                <tr key={student.id} className="hover:bg-gray-50 border-b border-gray-300">
                  ...
                  <td className="px-4 py-2 text-center">{student.payStat}</td>
                  <td className="px-4 py-2 text-center">{student.enrollStat}</td>
